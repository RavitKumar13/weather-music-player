...
var firstPerson = 'Ravit '; // Replace with the actual name
var firstLocation = 'Moradabad,Uttar Pradesh, India'; // Replace with the actual location

var secondPerson = 'waiting for name'; // Replace with the actual name
var secondLocation = 'not find';
